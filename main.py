...
train_dataset = Dataset(train_root, train_pd, train=True, transform=data_transforms['train'])
...
model.fc = torch.nn.Linear(in_features=in_features, out_features=cls_num)
